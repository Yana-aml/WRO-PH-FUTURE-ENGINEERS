...
| <img width="736" height="736" alt="LargeAngularMotor" src="https://github.com/user-attachments/assets/866299bf-008e-4e42-8092-8b0be2dc5bce" />|Large Motor | 1 | Used in the rear driving mechanism to power the back wheels and drive the robot forward. It provides strong power and torque, allowing the robot to move smoothly and carry its weight  during the run. 
| <img alt="Distancesensors" src="https://github.com/user-attachments/assets/b469a83b-bc39-4444-9bee-46cb3719ebef" />| Distance Sensors | 2 | The distance sensors are used to detect walls that are one placed in front and one on the side. They measure how far the robot is from the walls, helping it avoid collisions and maintain proper distance from the walls.
